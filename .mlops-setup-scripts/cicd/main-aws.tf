module "aws_create_sp" {
  ...
  service_principal_name       = "databricks-mlops-stack-cicd"
  project_directory_path       = "/databricks-mlops-stack"
  service_principal_group_name = "databricks-mlops-stack-service-principals"
}
