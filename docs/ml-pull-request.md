...
* [Staging workspace registered model](https://your-staging-workspace.cloud.databricks.com#mlflow/models/staging-databricks-mlops-stack-model)
* [Prod workspace registered model](https://your-prod-workspace.cloud.databricks.com#mlflow/models/prod-databricks-mlops-stack-model)
